...
<div>
	...
	<p>
		Prix : <i><?php echo $produit['art_price'] ?> €</i>
	</p>
		<?php if(isset($_SESSION['login']) && $_SESSION['login'] ['grade'] == 2){ echo '<a href="account.php?tab=2&article_id='.$produit['art_id'].'">Modifier</a>';} ?>
		<form method="post">
		<input type="hidden" name="buy"
			value=<?php echo '"'.$produit['art_id'].'"' ?>> 
		<input type="submit"
			value="Acheter">
	</form>
</div>
