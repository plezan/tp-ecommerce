...
<form method="post">
	<fieldset>
		<label>nom</label> <input type="text" name="art_name"><br /> <label>description</label>
		<input type="text" name="art_description"><br /> <label>price</label>
		<input type="text" name="art_price"><br /> <input type="submit">
	</fieldset>
</form>
